class SnapshotsController < ApplicationController
  ...
  def cloud_recordings
    ...
    @cameras = Camera.connection.select_all("select c.name, c.exid, c.id cam_id, c.is_online, c.is_public, u.username,u.firstname, u.lastname, u.id user_id, u.api_id, u.api_key ,cr.*,
