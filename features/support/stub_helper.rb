def camera_stubs(user)
  stub_request(:get, "https://api.evercam.io/v1/cameras.json?api_id=#{user.api_id}&api_key=#{user.api_key}&include_shared=true&thumbnail=false&user_id=user1").
