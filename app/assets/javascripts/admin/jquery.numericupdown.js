	...
	$.fn.extend({
		NumericUpDown: function(opt) {
			return this.each(function() {
				...
				opt = $.extend({
				    UpButtonImage: "assets/BGupbutton.png",
				    DownButtonImage: "assets/BGdownbutton.png",
        ...
        var count_up = $(document.createElement("i"));
        count_up.addClass("fa").addClass("fa-angle-up");
        UpBtn.append(count_up);

				var DnBtn = $(document.createElement("div"));
				DnBtn.addClass("down"); //.css("background-image", "URL('" + opt.DownButtonImage + "')");
        count_up = $(document.createElement("i"));
        count_up.addClass("fa").addClass("fa-angle-down");
        DnBtn.append(count_up)
